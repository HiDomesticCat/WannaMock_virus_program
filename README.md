...
![](binary_file_encryption beta2.3_encryption.jpeg)
...
### 程式將要使用者輸入解密金鑰，解密金鑰經過RSA解密後輸出原始金鑰，程式在檢查原始金鑰是否正確。其實沒有什麼實際的用途，只是我想將RSA加密應用進WannaFuxk爾已。
...
### 可以看到decryption_program.exe的程式碼，藍色線是會跳轉的程式碼會往哪一列跳，最左邊是列碼，第二行是機械語言，第三行是組合語言，最又是註釋，往下滑會看到列碼是0x00402a0d的那一列程式碼
...
### 在製作WannaFuxk時，我也遇到了很多問題要克服，英文資料的閱讀、子資料夾加密、RSA加密和製作這個文檔的乏味時間等，最後我還是打擺重重難關做完了WannaFuxk這個項目，我本人是還蠻滿意這個項目的。
